...
/**
 * 此FeedBuilder_502_1用于构建发送stype为502，数据版本为1的新鲜事
 * 新鲜事说明：修改状态
 * @author antonio
 *
 */

class FeedBuilder_502_1 {
	/**新鲜事的类型*/
	public final static int stype = 502;
	/**新鲜事的版本号*/

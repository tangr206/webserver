...
/**
 * 此FeedBuilder_2909_1用于构建发送stype为2909，数据版本为1的新鲜事
 * 新鲜事说明：评论相册发送给评论人好友(直接回复UGC)
 * @author antonio
 *
 */

class FeedBuilder_2909_1 {
	/**新鲜事的类型*/
	public final static int stype = 2909;
	/**新鲜事的版本号*/

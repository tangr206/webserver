...
/**
 * 此FeedBuilder_2908_1用于构建发送stype为2908，数据版本为1的新鲜事
 * 新鲜事说明：评论照片发送给评论人好友(直接回复UGC)
 * @author antonio
 *
 */

class FeedBuilder_2908_1 {
	/**新鲜事的类型*/
	public final static int stype = 2908;
	/**新鲜事的版本号*/
  ...
  public FeedBuilder_2908_1 () {
        ...
        _flag.put("lbs.id" , false);
        _flag.put("lbs.pid" , false);
        _flag.put("lbs.content" , false);
        _flag.put("lbs.longitude" , false);
        _flag.put("lbs.latitude" , false);
  ...
  /**
   *@param lbs_id comment:id
   */
  public void SetKey_lbs_id( String  lbs_id){
  ...
  /**
   *@param lbs_pid comment:pid
   */
  public void SetKey_lbs_pid( String  lbs_pid){
  ...
  /**
   *@param lbs_content comment:content
   */
  ...
  /**
   *@param lbs_longitude comment:longitude
   */
  ...
  /**
   *@param lbs_latitude comment:latitude
   */
  ...
  public void AddRepeat_album_photo(
      ...
      Map<String,String> obj = new HashMap<String,String>();
          ...
          obj.put("album.photo."+String.valueOf(count)+".source", String.valueOf(source ));
          ...
          obj.put("album.photo."+String.valueOf(count)+".digest", String.valueOf(digest ));

...
/**
 * 此FeedBuilder_2911_1用于构建发送stype为2911，数据版本为1的新鲜事
 * 新鲜事说明：评论照片发送给评论人好友（回复人）
 * @author antonio
 *
 */

class FeedBuilder_2911_1 {
	/**新鲜事的类型*/
	public final static int stype = 2911;
	/**新鲜事的版本号*/
  ...
  /**
   *@param album_count comment:video
   */

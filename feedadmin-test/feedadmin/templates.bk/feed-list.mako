  ...
  <tr>
    <th align="left" width="40%">
      <b style="font-size:120%;">新鲜事类型列表
          ...
          </select></b> &nbsp; &nbsp; <a href="/old-feed-list.htm">查看老版本列表</a>&nbsp; &nbsp; <a href="/feedTestTips.htm" target="_blank">新鲜事测试提示</a>
    </th>
    <th align="right" width="60%">
      <b style="font-size:120%;">注意：新鲜事模板更新时间——每周二、四的16:00</b>&nbsp; &nbsp; &nbsp;
    </th>
  </tr>
</table>
<table id="stype-list-table" width="1200" border="1" class="t1">
  <tr>
    ...
    <th width="200" rowspan="2">推送策略</th>

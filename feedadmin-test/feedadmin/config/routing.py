...
def make_map(config):
    ...
    map.connect('/stat', controller='FeedAdmin', action='Stat')
    map.connect('/get-statwebdata', controller='FeedAdmin', action='StatWebData')
    map.connect('/get-statalldata', controller='FeedAdmin', action='StatAllData')

    map.connect('/experi-signin', controller='FeedAdmin', action='ExperiSignin')
    map.connect('/experi-select', controller='FeedAdmin', action='ExperiSelect')
    map.connect('/experi-insert', controller='FeedAdmin', action='ExperiInsert')
    map.connect('/experi-list', controller='FeedAdmin', action='ExperiList')

    map.connect('/check-stype', controller='FeedAdmin', action='CheckStype')
    map.connect('/check-plat', controller='FeedAdmin', action='CheckPlat')
    map.connect('/view-day-list', controller='FeedAdmin', action='ViewDayList')
    map.connect('/web-day-list', controller='FeedAdmin', action='WebDayList')
    map.connect('/web-stype-list', controller='FeedAdmin', action='WebStypeList')
    map.connect('/stat-ABDebug', controller='FeedAdmin', action='ABDebug')
    map.connect('/stat-ABDebug-data', controller='FeedAdmin', action='ABDebugData')




    map.connect('/get-stat-data', controller='FeedAdmin', action='StatData')
    map.connect('/stat-detail', controller='FeedAdmin', action='StatDetail')
    map.connect('/stat-stype', controller='FeedAdmin', action='StatStype')
    map.connect('/stat-list', controller='FeedAdmin', action='StatList')

    map.connect('/quota', controller='FeedAdmin', action='Quota')
    map.connect('/get-quota-data', controller='FeedAdmin', action='QuotaData')
